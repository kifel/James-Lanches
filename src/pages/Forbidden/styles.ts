...
export const BannerForbidden = styled.div`
  max-width: 600px;
  height: 100%;
  display: flex;
...
export const TitleForbidden = styled.h2`
  font-size: 18vw;
  color: #fff;
  line-height: 1em;
...
export const SubTitleForbidden = styled.h4`
  position: relative;
  font-size: 1.5em;
  margin-bottom: 20px;
  color: #111;
...
export const DescriptForbidden = styled.p`
  color: #fff;
  font-size: 1.2em;
`;

export const ButtonForbidden = styled.button`
  align-items: center;
